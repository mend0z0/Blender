...
C_SRCS += \
../Drivers/Toslink/_drv_Toslink.c 

OBJS += \
./Drivers/Toslink/_drv_Toslink.o 

C_DEPS += \
./Drivers/Toslink/_drv_Toslink.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/Toslink/%.o Drivers/Toslink/%.su Drivers/Toslink/%.cyclo: ../Drivers/Toslink/%.c Drivers/Toslink/subdir.mk
...
clean: clean-Drivers-2f-Toslink

clean-Drivers-2f-Toslink:
	-$(RM) ./Drivers/Toslink/_drv_Toslink.cyclo ./Drivers/Toslink/_drv_Toslink.d ./Drivers/Toslink/_drv_Toslink.o ./Drivers/Toslink/_drv_Toslink.su

.PHONY: clean-Drivers-2f-Toslink
