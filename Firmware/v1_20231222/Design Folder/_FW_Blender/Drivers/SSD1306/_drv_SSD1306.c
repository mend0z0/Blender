...
static int8_t SSD1306SetXY( uint8_t x, uint8_t y);
...
TaskFunction_t _init_SSD1306( void * const pvParameters)
{
    ...
    while(1){
    	SSD1306SendData( ssd1306.mend0z0Logo, (mend0z0Logo_simpleBitmapsWidthPages * mend0z0Logo_simpleBitmapsHeightPixels));
